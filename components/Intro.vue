<template>
    <div class="container mx-auto px-6 py-16 text-start ">
        <div class="mx-auto max-w-4xl">
            ...
            <h1 class="animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white pr-5 text-5xl py-2 dark:text-white font-bold"
                v-html="infos.welcomeHeadline"></h1>

            <p class="text-2xl font-normal text-gray-800 dark:text-white " v-html="infos.briefBio"></p>
            ...
            <!-- <button
                class="mt-6 rounded-lg bg-blue-600 px-6 py-2.5 text-center text-xl font-medium capitalize leading-5 text-white hover:bg-blue-500 focus:outline-none lg:mx-0 lg:w-auto">Say Hello</button> -->
