    ...
    <footer class="bg-white dark:bg-gray-900">
        <div class="container mx-auto px-6 py-12">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div>
                    <p class="font-semibold text-gray-800 dark:text-white">Contact Me</p>

                    <div class="mt-5 flex flex-col items-start space-y-2">
                    
                        <a href="#"
                            class="text-gray-600 transition-colors duration-300 hover:text-blue-500 hover:underline dark:text-gray-300 dark:hover:text-blue-400">abdellah.allali.job@gmail.com</a>
                    </div>
                </div>
            </div> -->
            ...
            <div class="flex flex-col items-center justify-between sm:flex-row">
                ...
                <ul class="flex justify-center mt-5 space-x-5">
                    ...
                    <li>
                        <a href="https://twitter.com/is3dida" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                    ...
                    <li>
                        <a href="https://github.com/aallali/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                            <svg class="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/aallali/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">

                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-10 h-10"
                                viewBox="0 0 50 50" style="fill:#737373;">
                                <path
