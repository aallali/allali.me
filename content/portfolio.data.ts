export const infos = {
    ...
    longBio:
        `Hello, I'm Abdellah, a dedicated <b>software engineer</b> deeply passionate database internals and how storage engines works. My expertise spans modern <b>web technologies</b>, applied <b>machine learning</b>, and contributions to <b>open-source software</b>. Just got my Computer Architect Degree, primary focused around <b>data</b> and <b>low level system programming</b>.
<br>
<br> 
Throughout my journey,as a self-taught developer, I've independently acquired proficiency in a diverse range of technologies. I document my learning experiences on this blog, covering everything from tech-savvy insights into specific tools to invaluable development patterns. I regularly update the blog with articles that delve into my interests and the insights gained from my day-to-day experiences. Furthermore, you can explore some of my noteworthy <b>side projects</b> on my public GitHub repository.`,
    portfolio: {
        subtitle: '',
        projects: [
            {
